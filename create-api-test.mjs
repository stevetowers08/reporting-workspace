...
// This script tests all API endpoints through the browser console
...
writeFileSync('api-test-script.js', testScript);

console.log('📝 API test script created: api-test-script.js');
console.log('🌐 Open http://localhost:5173 in your browser');
console.log('📋 Copy and paste the contents of api-test-script.js into the browser console');
console.log('⏳ Or run: window.testAllAPIs() in the browser console');
