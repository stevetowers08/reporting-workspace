...
export const AdminHeader: React.FC<AdminHeaderProps> = ({
  ...
  if (isShared) return null; // Don't show admin header for shared views

  return (
    <header className="bg-slate-800 text-white border-b border-slate-700 sticky top-0 z-50 shadow-lg px-20">
      <div className="py-3">
