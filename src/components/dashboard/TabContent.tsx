...
export const TabContent: React.FC<TabContentProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Facebook Ads Tab */}
      <TabsContent value="facebook-all" className="space-y-6">
        <Card>
          <CardHeader>
      ...
      {/* Google Ads Tab */}
      <TabsContent value="google-all" className="space-y-6">
        <Card>
          <CardHeader>
      ...
      {/* Lead Quality Tab */}
      <TabsContent value="lead-quality" className="space-y-6">
        <Card>
          <CardHeader>
      ...
      {/* Event Analytics Tab */}
      <TabsContent value="event-analytics" className="space-y-6">
        <Card>
          <CardHeader>
