        ...
        <Card className="bg-white border border-slate-200 shadow-sm p-6 h-32">
          <div className="flex flex-col justify-between h-full">
            <div>
              ...
              <div className="flex items-baseline gap-2 mb-2">
                <p className="text-4xl font-bold text-slate-900">${(dashboardData?.leadMetrics?.overallCostPerLead || 0).toFixed(2)}</p>
                <div className="flex items-center gap-1">
        ...
        <Card className="bg-white border border-slate-200 shadow-sm p-6 h-32">
          <div className="flex flex-col justify-between h-full">
            <div>
              ...
              <div className="flex items-baseline gap-2 mb-2">
                <p className="text-4xl font-bold text-slate-900">{(dashboardData?.leadMetrics?.leadToOpportunityRate || 0).toFixed(1)}%</p>
                <div className="flex items-center gap-1">
