...
export class DatabaseService {
  ...
  static async getAllClients(): Promise<Client[]> {
    ...
    try {
      ...
      debugLogger.error('DatabaseService', 'Error fetching clients', error);
  ...
  static async getClientById(id: string): Promise<Client | null> {
    try {
      ...
      debugLogger.error('DatabaseService', 'Error fetching client', error);
      // Fallback to localStorage
  ...
  static async createClient(clientData: {
    ...
    try {
      ...
      debugLogger.error('DatabaseService', 'Error creating client', error);
      // Fallback to localStorage
  ...
  static async updateClient(id: string, updates: Partial<Client>): Promise<Client> {
    try {
      ...
      debugLogger.error('DatabaseService', 'Error updating client', error);
      // Fallback to localStorage
